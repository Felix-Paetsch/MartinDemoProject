...
export function get_message_partner(msg_partner_ident: string, env: Environment): Effect.Effect<MessagePartner, ProtocolError, ProtocolCommunicationHandlerT> {
    return pipe(
        MessagePartner.get_message_partner(msg_partner_ident, env),
...
export function get_message_partner_object(msg_partner_ident: MessagePartnerObjectIdent, env: Environment): Effect.Effect<MessagePartnerObject, ProtocolError, ProtocolCommunicationHandlerT> {
    return pipe(
...
export function guard_mpo_still_active(mpo: MessagePartnerObject): Effect.Effect<MessagePartnerObject, ProtocolError, ProtocolCommunicationHandlerT> {
