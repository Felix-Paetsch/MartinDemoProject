...
export type Protocol<
    Initiator = NoActor,
    Responder extends NonNullable<unknown> = NoActor,
    Result = void,
    InitData = null,
    ResponderIdentifier extends Json = Json
> = {
    name: string;
    ...
    findResponder: (identData: unknown | ResponderIdentifier, mc: MessageChannel) => null | Responder;
}
...
export function registerProtocol(protocol: Protocol<any, any, any, any, any>) {
