...
import { asyncCallbackAsEffect } from "../../../utils/boundary/callbacks";
        ...
        LEC.add_plugin_command({
                ...
                on_command: Effect.fn("call")(
                        function* (
                                ...
                                const res: Json = yield* asyncCallbackAsEffect(lib.implementation.call, fn, args, handler.message).pipe(
                                        Effect.catchAll(e => handler.errorR({
                                                message: e.message || "Failed to call function",
                                                error: e
                                        }))
